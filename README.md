...
myfile: Simple Single Golang Web Service

go-crud正式改名为myfile!

使用myfile开发Web服务: 用最简单的架构，实现够用的框架，服务海量用户

https://github.com/Gourouting/myfile
...
myfile框架为移动端提供Token登录的案例: https://github.com/bydmm/myfile-token-exmaple
## 目的
